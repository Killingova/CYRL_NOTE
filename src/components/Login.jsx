...
export default function Login({ onClose, onLogin }) {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-pastel-blue dark:bg-darkMode-background">
      <div className="bg-white p-8 rounded-lg shadow-lg dark:bg-gray-800 relative">
        <button
          onClick={onClose}
